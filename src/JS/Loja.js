...
function Loja (){
    return(
        ...
        <ul className="preco">
            <p className="money">R&#36;</p> <p className="five">5,20</p>
            <p className="money2">R&#36;</p> <p className="five2">5,00</p>
            <p className="money3">R&#36;</p> <p className="dez">10,00</p>
            <p className="money4">R&#36;</p> <p className="seven">7,00</p>
        </ul>

        <Baner4 className="footerlogo"/>
        </body>
    )
}
